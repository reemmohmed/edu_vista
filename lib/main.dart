...
import 'package:edu_vista/blocs/course/lecture/lecture_bloc.dart';
...
import 'package:edu_vista/MainScreenStatepages/main_screen.dart';
    ...
    return MaterialApp(
      ...
      onGenerateRoute: (settings) {
        ...
        switch (routeName) {
          ...
          case HomePage.id:
            //هنا اريد تغير home الي mainscreen
